...
import { Instagram, Twitter, Linkedin, Calendar, Award, Clock } from 'lucide-react'
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                ...
                <p className="text-gray-600 dark:text-gray-400">{trainer.experience}</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                <div className="flex items-center gap-2 mb-4">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(trainer.schedule).map(([day, times]) => (
                    <div key={day} className="border-b border-gray-200 dark:border-gray-700 last:border-0 pb-2">
