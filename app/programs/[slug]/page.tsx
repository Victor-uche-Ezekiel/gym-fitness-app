...
import { Calendar, Clock, DollarSign, CheckCircle2, Dumbbell, Users } from 'lucide-react'
      ...
      <div className="container px-4 mx-auto py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">About the Program</h2>
              <p className="text-gray-600 dark:text-gray-300 whitespace-pre-line">{program.longDescription}</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-xl p-8 mb-8 shadow-sm"
            >
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">Benefits</h2>
            ...
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-xl p-8 mb-8 shadow-sm"
            >
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">Equipment</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-xl p-8 mb-8 shadow-sm"
            >
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">Program Instructors</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="space-y-6">
                {program.faqs.map((faq, index) => (
                  <div key={index}>
                    <h3 className="text-lg font-medium mb-2 dark:text-white">{faq.question}</h3>
              ...
              <div className="space-y-3">
                {Object.entries(program.schedule).map(([day, times]) => (
                  <div key={day} className="flex justify-between items-center">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">{times[0]}</span>
                  </div>
                ))}
              </div>
            </motion.div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-2xl font-bold text-primary">${program.pricing.monthly}</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-2xl font-bold text-primary">${program.pricing.quarterly}</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-2xl font-bold text-primary">${program.pricing.yearly}</span>
                  </div>
