...
const values = [
  ...
  {
    title: 'Innovation',
    description: 'Constantly evolving and incorporating the latest fitness trends and technology.',
        ...
        <div className="container px-4 mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Founded in 2008, FitLife began with a simple mission: to create a fitness community that empowers people to achieve their health and wellness goals. What started as a small local gym has grown into a state-of-the-art fitness center, serving thousands of members with cutting-edge equipment and expert guidance.
            </p>
          </motion.div>
        </div>
      </section>
