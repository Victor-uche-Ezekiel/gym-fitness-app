...
const contactInfo = [
  {
    icon: MapPin,
    title: 'Location',
    details: ['123 Fitness Street', 'Workout City, WC 12345']
  },
  {
    icon: Phone,
    title: 'Phone',
    ...
    <main className="min-h-screen">
      ...
      <section className="py-24 bg-white dark:bg-gray-800">
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto">
            ...
            >
              <h2 className="text-4xl font-bold mb-4 dark:text-white">Send us a Message</h2>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-base dark:text-white">First Name</FormLabel>
                          <FormControl>
                            <Input 
                              placeholder="John" 
                              {...field}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-base dark:text-white">Last Name</FormLabel>
                          <FormControl>
                            <Input 
                              placeholder="Doe" 
                              {...field}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base dark:text-white">Email</FormLabel>
                        <FormControl>
                          <Input 
                            type="email" 
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base dark:text-white">Subject</FormLabel>
                        <FormControl>
                          <Input 
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base dark:text-white">Message</FormLabel>
                        <FormControl>
                          <Textarea 
      ...
      <section className="h-[400px] bg-gray-200 dark:bg-gray-900">
        <div className="w-full h-full bg-gray-300 dark:bg-gray-800 flex items-center justify-center">
          <p className="text-gray-600 dark:text-gray-300">Map will be implemented here</p>
        </div>
      </section>
    </main>
  )
